...
from droneload.rectFinder.show import draw_rectangles, draw_coordinate, draw_scene
from droneload.rectFinder.calibration import calibration, calibrate_image_size
from droneload.rectFinder.rect import Rect, remove_old_rects, get_current_rects
