...
def main():
    ...
    vrect_parser.add_argument("--tol", help="Tolerance for rectangle detection", type=float, default=tol)
    vrect_parser.add_argument("--info", help="Show info about the rectangle", action="store_true")
    vrect_parser.add_argument("--fit", help="Threshold for rectangle fit", type=float, default=fit)
    ...
    imrect_parser.add_argument("--tol", help="Tolerance for rectangle detection", type=float, default=tol)
    ...
    impath_parser.add_argument("--tol", help="Tolerance for rectangle detection", type=float, default=tol)
